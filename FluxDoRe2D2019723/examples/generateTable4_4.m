% This file is modified from \FluxDoRe2D2019723\examples\demoValidation.m
% It will reproduce the left column of table4.4
try   
    parpool('local',1) %disable parallel computation. 
catch 
